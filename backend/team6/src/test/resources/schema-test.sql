...
ALTER TABLE member ADD CONSTRAINT fk_member_info FOREIGN KEY (member_info_id) REFERENCES member_info(member_info_id);
ALTER TABLE member ADD CONSTRAINT fk_dept FOREIGN KEY (dept_id) REFERENCES dept(dept_id);
ALTER TABLE member ADD CONSTRAINT fk_position FOREIGN KEY (position_id) REFERENCES code(code_id);

ALTER TABLE dept ADD CONSTRAINT fk_dept_leader FOREIGN KEY (dept_leader_id) REFERENCES member(member_id);

ALTER TABLE vacation_request ADD CONSTRAINT fk_vacation_type FOREIGN KEY (type_code) REFERENCES code(code_id);
ALTER TABLE vacation_request ADD CONSTRAINT fk_vacation_member FOREIGN KEY (member_id) REFERENCES member(member_id);

ALTER TABLE approval_step ADD CONSTRAINT fk_approval_member FOREIGN KEY (member_id) REFERENCES member(member_id);
